...
export default function EventsDeletedTable() {
    const {EventsDeletedRef,getData,EventRefrence} = useContext(FireBaseContext)
        ...
        <TableBody >
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="right"><KeyboardReturnIcon onClick={()=>returnData(row.ID)} className='bg-success text-white rounded-2'/></TableCell>
