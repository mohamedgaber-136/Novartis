  ...
  return (
    <div className="px-4 d-flex flex-md-row flex-column justify-content-center gap-3 align-items-center StepTwoParent ">
      ...
      <div className="StepTwoContent mb-3 d-flex flex-column gap-4 align-items-start justify-content-between">
        ...
        <div>
          <p>
            <b className="text-secondary">By accepting this,</b>, I explicitly declare that I have been informed of the obligation to disclose to the SFDA any financial support received from Novartis Saudi Ltd. I also consent the processing, saving and publication of my personal data including (Full name, National or Iqama ID, Medical License number, phone number and email address) in relation to any Transfer of Value as defined in the financial Transparency and Disclosure guideline of SFDA." I also, hereby declare that I’ve read and understood Novartis Privacy Notice and acknowledge my consent to the collection and processing of my data in accordance with the terms of this <b><a href="https://firebasestorage.googleapis.com/v0/b/novartis-f3745.appspot.com/o/pdf%2FHCPS_%20KSA%20updated%20Privacy%20Notice_%20Template_%2031%20Jan%202024.pdf?alt=media&token=ab6c0442-18fb-4aa4-8fa2-96cfea05844a" target="_blank">Privacy Notice</a></b>.
