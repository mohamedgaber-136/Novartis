...
export default function TeamsTable({ row}) {
  ...
  const { EventRefrence, setRows, rows } = React.useContext(FireBaseContext);
  React.useEffect(() => {
    setRows(row);
  }, [row]);
            ...
            {visibleRows.map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell align="left" className="TabelCoulmTeams">
                    <button className="btn btn-outline-primary p-2 rounded rounded-2">
                      GO TO MY EVENTS
                    </button>
                  </TableCell>
                </TableRow>
